  ...
  computed: {
    ...
    dynamicStyles() {
      return {
        ...
        '--feiertag-textfarbe': this.content?.feiertag_textfarbe || '#c92a2a',
        '--feiertag-rahmenfarbe': this.content?.feiertag_rahmenfarbe || '#ffc9c9',
...
.datums-zelle {
  ...
  &.feiertag {
    background-color: var(--feiertag-farbe);
    opacity: 0.5;
    border-left: 2px solid var(--feiertag-rahmenfarbe);
  }
